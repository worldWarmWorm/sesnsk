...
$this->pageTitle = 'Препараты'.' / Категория '. $model->title . ' - '. $this->appName; 
...
<div class="row pull-right" style="margin-top: 5px;">
	<div class="checkbox">
		<? $this->widget('\common\widgets\form\SwitchField', [
			...
			'label'=>'Скрыть привязанные товары ',
...
$(document).ready(function() {
	$(document).on("switchChange.bootstrapSwitch", Kontur.DataJs.expr("switch-hide-related-products"), function(e) {
		window.location.href="?hide_related="
			+ (Kontur.DataJs.get("switch-hide-related-products").is(":checked") ? 1 : 0);
	});
});
</script>
<? endif; ?>
