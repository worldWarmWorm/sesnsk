...
<head>
	...
	<? Y::cs()->registerScriptFile('/js/jquery-migrate-1.2.1.min.js'); ?>
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class="nav navbar-nav navbar-right">
              <?php if (D::role('sadmin')) {
				echo CHtml::tag('li', [], CHtml::link('DEVCP <i class="glyphicon glyphicon-lock"></i>', '/devcp/', ['target'=>'_blank']));
			  	echo CHtml::tag('li', [], CHtml::link('Инфо-блоки <i class="glyphicon glyphicon-lock"></i>', '/cp/iblock'));
              } ?>
              <li><?= CHtml::link('Настройки <i class="glyphicon glyphicon-cog"></i>', ['default/settings']); ?>
              <li><?= CHtml::link('Выход <i class="glyphicon glyphicon-off"></i>', ['default/logout']); ?>
            </ul>
