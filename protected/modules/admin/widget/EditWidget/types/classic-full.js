...
//    plugins : "hr, colorpicker, emoticons, code, visualchars, wordcount, link, -ymap, image, autolink,lists, pagebreak,layer,table, save,insertdatetime, preview,media, searchreplace,print, contextmenu,paste,directionality,fullscreen,noneditable, visualchars,nonbreaking,template",
 plugins: [
  ...
  toolbar3: "table  tablecontrols| hr removeformat | subscript superscript | charmap emoticons | print fullscreen | ltr rtl | visualchars visualblocks nonbreaking template pagebreak restoredraft | other cms_gallery_1 cms_gallery_2 ymap | <?php if(D::cms('tinymce_adaptivy')) echo "makeResponsive"; ?>",
