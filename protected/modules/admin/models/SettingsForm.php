...
class SettingsForm extends CFormModel
{
    ...
    public function rules()
    {
    	$rules =  array(
            ...
            array('sitename', 'length', 'max'=>40),
            array('slogan, address, sitename, phone, phone2, email, emailPublic, youtube, firm_name, counter, hide_news, menu_limit', 'safe'),
        ...
        if(D::yd()->isActive('shop') && D::role('sadmin')) {
            $rules = \CMap::mergeArray($rules, array(
            	...
            	array('shop_title, shop_enable_hit_on_top, shop_pos_description, shop_enable_attributes', 'safe'),
