				...
				'attributes'=>[
					...
					'image'=>[
						...
						'params'=>[
							...
							'tmbWidth'=>$slider->optionsBehavior->find('code', 'width', ['returnValue'=>'value'])?:Slider::WIDTH,
							'tmbHeight'=>$slider->optionsBehavior->find('code', 'height', ['returnValue'=>'value'])?:Slider::HEIGHT,
							'tmbProportional'=>in_array($slider->optionsBehavior->find('code', 'proportional', ['returnValue'=>'value']), [null, 'yes', 1])
						]
					],
