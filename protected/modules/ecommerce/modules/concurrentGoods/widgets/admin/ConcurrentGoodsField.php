<?php
/**
 * Виджет поля выбора сопутсвующего товара.
 */
namespace ecommerce\modules\concurrentGoods\widgets\admin;

use common\components\helpers\HDb;
use ecommerce\modules\concurrentGoods\models\ConcurrentGoods;

class ConcurrentGoodsField extends \common\components\widgets\form\BaseField
{
	/**
	 ...
	 */
	public $view='concurrent_goods_field';
	...
	public function getData()
	{
		if($this->data === null) {
			...
			$this->data=ConcurrentGoods::model()
				->scopeSort($this->sort)
